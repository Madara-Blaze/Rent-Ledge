      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-4">
          ...
          <label className="flex items-start gap-2.5 text-sm text-white/60">
            ...
            <span>
              I agree to the{' '}
              <Link to="/terms" target="_blank" className="text-white underline-offset-4 hover:underline">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link to="/privacy" target="_blank" className="text-white underline-offset-4 hover:underline">
                Privacy Policy
              </Link>
              .
            </span>
          ...
          <Button type="submit" variant="primary" size="lg" className="w-full" disabled={busy || !agreed}>
