...
export const invoices = pgTable(
  'invoices',
  {
    ...
    // GST (commercial lets): amountMinor stays gross; these carry the breakdown.
    taxableMinor: money('taxable_minor'),
    cgstMinor: money('cgst_minor'),
    sgstMinor: money('sgst_minor'),
    igstMinor: money('igst_minor'),
